...
This directory contains internal documentation for the `@outoforbitdev/galaxy-map` library. It is intended for developers contributing to or maintaining this library, as well as AI coding agents working within this codebase.
